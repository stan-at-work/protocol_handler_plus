...
class ProtocolHandlerPlus {
  ProtocolHandlerPlus._();

  /// The shared instance of [ProtocolHandlerPlus].
  static final ProtocolHandlerPlus instance = ProtocolHandlerPlus._();

  ProtocolHandlerPlusPlatform get _platform => ProtocolHandlerPlusPlatform.instance;
  ...
  List<ProtocolListener> get listeners {
    final List<ProtocolListener> localListeners = List<ProtocolListener>.from(
      _listeners,
    );
...
final protocolHandlerPlus = ProtocolHandlerPlus.instance;
